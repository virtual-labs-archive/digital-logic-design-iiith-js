...
simcir.registerDevice('Parallel Shift Reg',
{
  ...
  "devices":[
    {"type":"In","id":"dev0","x":104,"y":48,"label":"J"},
    {"type":"In","id":"dev1","x":104,"y":104,"label":"K"},
    {"type":"DC","id":"dev2","x":24,"y":216,"label":"DC"},
    {"type":"In","id":"dev3","x":104,"y":160,"label":"D0"},
    {"type":"In","id":"dev4","x":104,"y":216,"label":"D1"},
    {"type":"In","id":"dev5","x":104,"y":272,"label":"D2"},
    {"type":"In","id":"dev6","x":104,"y":328,"label":"D3"},
    {"type":"In","id":"dev7","x":104,"y":384,"label":"M"},
    {"type":"In","id":"dev8","x":104,"y":440,"label":"CLK"},
    {"type":"Selector","id":"dev9","x":200,"y":32,"label":"Selector"},
    {"type":"Joint","id":"dev10","x":168,"y":56,"label":"Joint","state":{"direction":0}},
    {"type":"Joint","id":"dev11","x":152,"y":392,"label":"Joint","state":{"direction":0}},
    {"type":"Selector","id":"dev12","x":200,"y":120,"label":"Selector"},
    {"type":"Joint","id":"dev13","x":168,"y":136,"label":"Joint","state":{"direction":0}},
    {"type":"JK-FF","id":"dev14","x":384,"y":32,"label":"JK-FF"},
    {"type":"NOT","id":"dev15","x":328,"y":64,"label":"NOT"},
    {"type":"Joint","id":"dev16","x":304,"y":440,"label":"Joint","state":{"direction":3}},
    {"type":"Joint","id":"dev17","x":312,"y":48,"label":"Joint","state":{"direction":0}},
    {"type":"Joint","id":"dev18","x":464,"y":216,"label":"Joint","state":{"direction":3}},
    {"type":"Selector","id":"dev19","x":528,"y":32,"label":"Selector"},
    {"type":"Joint","id":"dev20","x":472,"y":72,"label":"Joint","state":{"direction":0}},
    {"type":"Joint","id":"dev21","x":496,"y":392,"label":"Joint","state":{"direction":0}},
    {"type":"Joint","id":"dev22","x":496,"y":56,"label":"Joint","state":{"direction":3}},
    {"type":"D-FF","id":"dev23","x":640,"y":48,"label":"D-FF"},
    {"type":"D-FF","id":"dev24","x":824,"y":192,"label":"D-FF"},
    {"type":"Selector","id":"dev25","x":720,"y":120,"label":"Selector"},
    {"type":"Selector","id":"dev26","x":928,"y":256,"label":"Selector"},
    {"type":"D-FF","id":"dev27","x":1040,"y":352,"label":"D-FF"},
    {"type":"Joint","id":"dev28","x":680,"y":160,"label":"Joint","state":{"direction":3}},
    {"type":"Joint","id":"dev29","x":888,"y":296,"label":"Joint","state":{"direction":3}},
    {"type":"Out","id":"dev30","x":1168,"y":344,"label":"Q3"},
    {"type":"Out","id":"dev31","x":1160,"y":64,"label":"Q0"},
    {"type":"Out","id":"dev32","x":1160,"y":136,"label":"Q1"},
    {"type":"Joint","id":"dev33","x":792,"y":224,"label":"Joint","state":{"direction":3}},
    {"type":"Joint","id":"dev34","x":1008,"y":376,"label":"Joint","state":{"direction":3}},
    {"type":"Joint","id":"dev35","x":608,"y":80,"label":"Joint","state":{"direction":3}},
    {"type":"Joint","id":"dev36","x":664,"y":136,"label":"Joint","state":{"direction":0}},
    {"type":"Joint","id":"dev37","x":856,"y":272,"label":"Joint","state":{"direction":0}},
    {"type":"Out","id":"dev38","x":1160,"y":232,"label":"Q2"},
    {"type":"Joint","id":"dev39","x":536,"y":8,"label":"Joint","state":{"direction":0}}
  ],
  "connectors":[
    ...
    {"from":"dev18.in0","to":"dev4.out0"},
    {"from":"dev19.in0","to":"dev14.out0"},
    {"from":"dev19.in1","to":"dev22.out0"},
    {"from":"dev19.in2","to":"dev20.out0"},
    {"from":"dev20.in0","to":"dev18.out0"},
    {"from":"dev21.in0","to":"dev11.out0"},
    {"from":"dev22.in0","to":"dev21.out0"},
    {"from":"dev23.in0","to":"dev19.out0"},
    {"from":"dev23.in1","to":"dev35.out0"},
    {"from":"dev24.in0","to":"dev25.out0"},
    {"from":"dev24.in1","to":"dev33.out0"},
    {"from":"dev25.in0","to":"dev23.out0"},
    {"from":"dev25.in1","to":"dev36.out0"},
    {"from":"dev25.in2","to":"dev28.out0"},
    {"from":"dev26.in0","to":"dev24.out0"},
    {"from":"dev26.in1","to":"dev37.out0"},
    {"from":"dev26.in2","to":"dev29.out0"},
    {"from":"dev27.in0","to":"dev26.out0"},
    {"from":"dev27.in1","to":"dev34.out0"},
    {"from":"dev28.in0","to":"dev5.out0"},
    {"from":"dev29.in0","to":"dev6.out0"},
    {"from":"dev30.in0","to":"dev27.out0"},
    {"from":"dev31.in0","to":"dev39.out0"},
    {"from":"dev32.in0","to":"dev23.out0"},
    {"from":"dev33.in0","to":"dev16.out0"},
    {"from":"dev34.in0","to":"dev16.out0"},
    {"from":"dev35.in0","to":"dev16.out0"},
    {"from":"dev36.in0","to":"dev21.out0"},
    {"from":"dev37.in0","to":"dev21.out0"},
    {"from":"dev38.in0","to":"dev24.out0"},
    {"from":"dev39.in0","to":"dev14.out0"}
  ]
}
);
simcir.registerDevice('Selector',
{
  "width":420,
  "height":260,
  "showToolbox":false,
  ...
  "devices":[
    {"type":"NAND","id":"dev0","x":496,"y":176,"label":"NAND"},
    {"type":"Out","id":"dev1","x":584,"y":176,"label":"x"},
    {"type":"NAND","id":"dev2","x":392,"y":144,"label":"NAND"},
    {"type":"NAND","id":"dev3","x":392,"y":216,"label":"NAND"},
    {"type":"NOT","id":"dev4","x":312,"y":192,"label":"NOT"},
    {"type":"Joint","id":"dev5","x":288,"y":160,"label":"Joint","state":{"direction":0}},
    {"type":"DC","id":"dev6","x":104,"y":168,"label":"DC"},
    {"type":"In","id":"dev7","x":216,"y":112,"label":"A"},
    {"type":"In","id":"dev8","x":216,"y":224,"label":"C"},
    {"type":"In","id":"dev9","x":216,"y":168,"label":"B"}
  ],
  "connectors":[
    {"from":"dev0.in0","to":"dev2.out0"},
...
simcir.registerDevice('4bitAdder',
{
  ...
  "devices":[
    ...
    {"type":"In","id":"dev4","x":40,"y":416,"label":"B3"},
    {"type":"Out","id":"dev5","x":200,"y":72,"label":"S0"},
    {"type":"Out","id":"dev6","x":200,"y":120,"label":"S1"},
    {"type":"Out","id":"dev7","x":200,"y":168,"label":"S2"},
    {"type":"Out","id":"dev8","x":200,"y":216,"label":"S3"},
    {"type":"Out","id":"dev9","x":200,"y":280,"label":"Cout"},
    {"type":"In","id":"dev10","x":40,"y":24,"label":"A0"},
    {"type":"In","id":"dev11","x":40,"y":80,"label":"B0"},
    {"type":"In","id":"dev12","x":40,"y":128,"label":"C0"},
    {"type":"In","id":"dev13","x":40,"y":176,"label":"A1"},
    {"type":"In","id":"dev14","x":40,"y":224,"label":"B1"},
    {"type":"In","id":"dev15","x":40,"y":272,"label":"A2"},
    {"type":"In","id":"dev16","x":40,"y":320,"label":"B2"},
    {"type":"In","id":"dev17","x":40,"y":368,"label":"A3"}
  ],
  "connectors":[
    {"from":"dev0.in0","to":"dev12.out0"},
    {"from":"dev0.in1","to":"dev10.out0"},
    {"from":"dev0.in2","to":"dev11.out0"},
    ...
    {"from":"dev3.in1","to":"dev17.out0"},
    {"from":"dev3.in2","to":"dev4.out0"},
    {"from":"dev5.in0","to":"dev0.out0"},
    {"from":"dev6.in0","to":"dev1.out0"},
    {"from":"dev7.in0","to":"dev2.out0"},
    {"from":"dev8.in0","to":"dev3.out0"},
    {"from":"dev9.in0","to":"dev3.out1"}
  ]
}
);
