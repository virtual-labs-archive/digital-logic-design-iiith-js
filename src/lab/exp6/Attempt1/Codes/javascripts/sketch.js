...
function setup() { // jshint ignore:line
    ...
    document.title = 'New Sketch - VLabs';
    ...
    */
    ...
    if (loadfile !== "") {
        document.title = String(loadfile + ' - VLabs');
...
function showTutorial() {
    ...
    switch (hintNum) {
        case 0:
            displayHint(450, hintPic0, 'Welcome!', 'If this is your first time using VLabs,',
        ...
        case 17:
            displayHint(400, hintPic17, 'Loading and saving', 'To load sketches, you must have a local',
                'VLabs version on your computer. ');
            break;
        case 18:
            displayHint(700, hintPic16, 'Loading and saving', 'Make sure, your sketch file is in the \'sketches\' folder of your VLabs version.',
        ...
        case 26:
            ...
            break;
        case 27:
            displayHint(600, hintPic0, 'Thank you!', 'You\'ve reached the end of this little tutorial on VLabs.',
